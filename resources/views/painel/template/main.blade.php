...
<head>
    ...
    <meta charset="utf-8" />
    <title>Casas Temporada - Painel Administrativo</title>
    <meta content="Painel de controle da Casa Temporada" name="description" />
            ...
            <div data-simplebar class="h-100">
                ...
                <div id="sidebar-menu">
                    ...
                    <ul class="metismenu list-unstyled mt-3" id="side-menu">
                        ...
                        <li>
                            <a href="javascript: void(0);" class="waves-effect">
                                <i class="fas fa-home menu-icon" aria-hidden="true"></i>
                                <span key="t-dashboards">Imóveis</span>
                            </a>
                            <ul class="sub-menu" aria-expanded="false">
                                <li><a href="{{ route('painel.imoveis') }}" key="t-default">Cadastros</a></li>
                            </ul>
                        </li>
